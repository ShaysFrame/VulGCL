...
for sym, lbl, col, bg, cy, hints in branch_info:
    ...
    txt(ax, 2.7, cy+0.1, hints[0], ha="right",
        va="center", fontsize=7, color=col)
    txt(ax, 2.7, cy-0.2, hints[1], ha="right",
        va="center", fontsize=7, color="#546E7A")
...
txt(ax, 12.05, 4.85, "256 → 128 → 1", ha="center",
    va="center", fontsize=8, color="white")
txt(ax, 12.05, 4.48, "+ Sigmoid",      ha="center",
    va="center", fontsize=8, color="white")

# output probability bar
ax.annotate("", xy=(13.4+0.1, 5.0), xytext=(13.22, 5.0),
            arrowprops=dict(arrowstyle="-|>", color=C_F, lw=1.8, mutation_scale=12))

txt(ax, 13.65, 5.65, "P(vuln)", ha="center", va="center",
    fontsize=9.5, fontweight="bold", color=C_F)
# background bar
box(ax, 13.2+0.3, 4.85, 0.88, 0.3, "#FFCDD2", C_F, lw=1.2, rad=0.04, zo=5)
# filled portion = 0.78
box(ax, 13.2+0.3, 4.85, 0.88*0.78, 0.3, C_F, C_F, lw=0, rad=0.04, zo=6)
txt(ax, 13.64+0.3, 5.0, "0.78", ha="center", va="center",
