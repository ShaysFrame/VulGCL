...
More recently, the exploration of visual code representations has extended to 
Vision-Language Models (VLMs). Specifically, CodeOCR~\cite{codeocr} demonstrates 
that multimodal LLMs can understand code rendered as screenshots and exhibit 
resilience to visual compression. Unlike general-purpose VLM-based approaches 
that require massive computational footprints, VulGCL utilizes a lightweight, 
task-specific centrality image and CNN design designed for efficient execution.
